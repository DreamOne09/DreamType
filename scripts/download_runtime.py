...
apk=ROOT.parent/'outputs/android/DreamType-0.6.0.apk'
urllib.request.urlretrieve('https://github.com/DreamOne09/DreamType/releases/download/v0.6.0/DreamType.apk',apk)
if hashlib.sha256(apk.read_bytes()).hexdigest() != 'ac4888f9b8a8ff7e9f6cd448471d1d1f03e83ba1cce34d181b142cf2671fca43':raise RuntimeError('APK checksum mismatch')
